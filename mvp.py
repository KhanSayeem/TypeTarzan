...
wpm = 0
decrease_speed_after_interval = 0.25 # cars speed will slow down after this much time of inactivity
decrease_speed_rate = 0.88
...
def wpm_to_speed(wpm): return wpm/10 # The entire game is 60fps, if the return raw wpm as speed then the car will go out of screen
...
while True:
    ...
    scroll = (scroll + car_speed) % road_height # counter to keep inside 600, 
                                                # When (scroll + car_speed) = 600, (% road_height) resets to 0
